...
class BaseSerializer(ABC):
    ...
    def _serialize_instance(self, instance: object) -> dict:
    ...
    def serialize(self) -> dict | list[dict]:
        if not isinstance(self.to_serialize, Iterable):
            return self._serialize_instance(self.to_serialize)
        return [self._serialize_instance(instance) for instance in self.to_serialize]
